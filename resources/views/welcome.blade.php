...
<head>
    ...
    <style>
        ...
        .hero-section {
            background: url('https://source.unsplash.com/1600x900/?furniture,interior') no-repeat center center/cover;
            color: #fff;
            height: 100vh;
            display: flex;
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="https://source.unsplash.com/300x200/?livingroom" class="card-img-top" alt="Sofa">
                        <div class="card-body">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="https://source.unsplash.com/300x200/?table,chair" class="card-img-top" alt="Meja & Kursi">
                        <div class="card-body">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="https://source.unsplash.com/300x200/?bedroom" class="card-img-top" alt="Tempat Tidur">
                        <div class="card-body">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="https://source.unsplash.com/300x200/?furniture" class="card-img-top" alt="Dekorasi">
                        <div class="card-body">
                            <h5 class="card-title text-center">Dekorasi</h5>
                        </div>
                    </div>
                </div>
            </div>
